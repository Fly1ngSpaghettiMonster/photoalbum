...
namespace PhotoAlbum.Web.Migrations
{
    ...
    [Migration("20260228143150_RefactorPhotoToFluentConfig")]
    partial class RefactorPhotoToFluentConfig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhotoAlbum.Web.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PhotoAlbum.Web.Data.Photo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PhotoAlbum.Web.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PhotoAlbum.Web.Data.Photo", b =>
                {
                    b.HasOne("PhotoAlbum.Web.Data.ApplicationUser", "OwnerUser")
                        .WithMany()
